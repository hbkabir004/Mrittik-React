                    ...
                    <ul className="popular_product_list">
                        <li className="popular_product_item">
                            ...
                            <div className="popular_product_content">
                                <h5 className="product_title"><a href="shop-product.html">Decor Plant</a></h5>
                        ...
                        <li className="popular_product_item">
                            ...
                            <div className="popular_product_content">
                                <h5 className="product_title"><a href="shop-product.html">Center Table</a></h5>
                                <h6 className="product_price">$22.00</h6>
                            </div>
                        </li>
                        <li className="popular_product_item">
                            ...
                            <div className="popular_product_content">
                                <h5 className="product_title"><a href="shop-product.html">Black Vase</a></h5>
                                <h6 className="product_price">$22.00</h6>
                            </div>
                        </li>
                    </ul>
